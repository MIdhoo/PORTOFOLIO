    ...
    <section id="projects" className="section">
      <div className="container">
        ...
        <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "24px", width: "100%" }}>
          {items.map((p, i) => (
            <article key={i} className="card-base" style={{ width: "100%", maxWidth: "380px", flex: "1 1 300px", display: "flex", flexDirection: "column" }}>
              <div className="thumb">
                {p.img ? (<img src={p.img} alt={p.title} loading="lazy" />) : 
                (<div style={{ width: "100%", height: "100%", background: "#1f1f2e", display: "flex", alignItems: "center", justifyContent: "center", color: "#555" }}>No Image</div>)}
              </div>
